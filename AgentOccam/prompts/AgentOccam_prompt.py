...
* CRITICAL: For questions about quantities, amounts, prices, spending, or numerical values:
  - You MUST include the specific number or amount in your response
  - If the answer is zero or no spending/quantity, you MUST explicitly state "0" or "$0" in your response
  - Examples: "You spent $0", "The total is 0 items", "Amount: $0"
  - Do NOT say "nothing" or "no items" without also stating the equivalent number''',
